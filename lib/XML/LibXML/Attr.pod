...
allways use the createAttrbute of XML::LibXML::Document.
...
This is needed to set a new attributevalue. If iso encoded strings are passed
...
node, undef will be returned. Overwriting the underlaying implementation, the
